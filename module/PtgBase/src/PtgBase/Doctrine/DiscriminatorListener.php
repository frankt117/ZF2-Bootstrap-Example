...
{  
    ...
    const ENTRY_ANNOTATION = 'PtgBase\Doctrine\DiscriminatorEntry';  
    ...
    {  
        $annotations = \PtgBase\Doctrine\Annotation::getAnnotationsForClass( $class );  
        $success = false;  
